            ...
            return [
                ...
                <div className={ className }>
                    ...
                    <div className="row no-gutters">
                        ...
                        <div class={attributes.selectedView == 'right' ?  "col-3 col-md-1 col-lg-2 order-lg-3" : "col-3 col-md-1 col-lg-2"}>
                        ...
                        <div class={attributes.selectedView == 'right' ? "col-9 col-md-5 col-lg-4 order-lg-2" : "col-9 col-md-5 col-lg-4"}>
                            <MediaUpload
                        ...
                        <div className={attributes.selectedView == 'right' ? "col-12 col-md mb-2 mb-md-0 mt-3 mt-md-0 pb-2 pl-md-4 pl-lg-0 pr-lg-4 order-lg-1" : "col-12 col-md mt-3 mt-md-0 pb-2 pl-md-4"}>
                            <RichText
                                tagName="h2"
